...
- [ ] 2.3 Wrap navigation elements in `GlassEffectContainer` where needed
...
- [ ] 3.4 Apply glass to primary action buttons across views
- [ ] 3.5 Apply glass to secondary/bordered buttons

## 4. Content Cards

- [x] 4.1 Update story cards with `.liquidGlassCard()` modifier
- [ ] 4.2 Update hero cards in `AdaptiveHeroGridView.swift`
- [ ] 4.3 Update event cards in `EnhancedEventPickerView.swift`
- [ ] 4.4 Update story cards in `ImprovedStoryLibraryView.swift`
- [ ] 4.5 Apply glass to custom event cards
...
- [ ] 6.2 Update `NetworkRequiredView.swift` with glass styling
- [ ] 6.3 Update `IllustrationCarouselView.swift` controls with glass
- [ ] 6.4 Update `IllustrationSyncView.swift` timeline with glass
- [ ] 6.5 Update loading indicators with glass backgrounds

## 7. Polish and Transitions

- [ ] 7.1 Add `GlassEffectContainer` to views with multiple glass elements
- [ ] 7.2 Implement glass morphing transitions between related elements
- [ ] 7.3 Ensure glass tinting uses `.accentColor` consistently
- [ ] 7.4 Review and adjust corner radii for glass shapes
