...
- [ ] 3.1 Extract term replacements from `generate-illustration/route.ts` (~40 terms)
- [ ] 3.2 Extract term replacements from `generate-avatar/route.ts` (deduplicate)
- [ ] 3.3 Extract safety terms from `content-filter.ts` (5 languages)
...
- [ ] 5.1 Refactor `avatar-generator.ts` `buildAvatarPrompt()` to use PromptBuilder
- [ ] 5.2 Update `/api/heroes/[heroId]/avatar/route.ts` to use new builder
...
- [ ] 6.1 Refactor `story-generator.ts` `getSystemPrompt()` and `getUserPrompt()`
- [ ] 6.2 Update `/api/stories/generate/route.ts`
- [ ] 6.3 Update `/api/stories/generate-custom/route.ts`
...
- [ ] 7.1 Refactor `illustration-generator.ts` `buildIllustrationPrompt()`
- [ ] 7.2 Update `/api/images/generate-illustration/route.ts`
- [ ] 7.3 Remove duplicated sanitization from route
- [ ] 7.4 Verify character consistency prompts work correctly
- [ ] 7.5 Add tests for illustration prompt generation

## 8. Migrate Remaining Services
- [ ] 8.1 Refactor `visual-consistency-service.ts` prompts
- [ ] 8.2 Refactor AI assistant routes (sanitize-prompt, enhance-prompt, etc.)
- [ ] 8.3 Update `content-filter.ts` to use centralized rules
- [ ] 8.4 Remove deprecated inline sanitization functions
