...
Define the systematic deprecation and removal of legacy code that directly integrated with OpenAI APIs, transitioning fully to backend-proxied API calls.
## Requirements
